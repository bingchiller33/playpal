...
const SquadPage = (pageProps: NextPageProps) => {
    const { params } = pageProps;
    const { id, page } = params;
    const dummy = {
        name: "Dummy squad name",
        avatar: null,
    };

    let main;
    if (page === "filters") {
        main = <SquadFilter {...pageProps} />;
    } else if (page === "chat") {
    ...
    return (
        <div className={cx(styles.layout, "m-md-3")}>
            <div
                ...
                style={{ gridArea: "l" }}
            >
                <SquadsRibbon squads={[{ name: "GG" }, { name: "GG" }]} />
            </div>
            <div
                className={cx(
            ...
            <div className="d-md-none" style={{ gridArea: "t" }}>
