                                    ...
                                    <div className={styles.formGroup}>
                                        <div className={styles.avatarContainer}>
                                            ...
                                            <p className={styles.imageSizeInfo}>
                                                Image size should not be larger
                                                than 1MB.
                                            </p>
                                            <p className={styles.imageSizeInfo}>
                                                Please ensure your avatar
                                                adheres to the Visual content
                                                considerations.
                                            </p>
                                        </div>
                                    </div>
                            ...
                            {activeTab === "premium" && (
                                <>
                                    <div className="">
                                        ...
                                        {premiumExpire ? (
                                            <p>
                                                You are subscribed to PlayPal
                                                Premium! Thank you for
                                                supporting us
                                                <br />
                                            ...
                                            <p>
                                                This user is not subscribed to
                                                PlayPal Premium.
                                            </p>
                                        )}
                                        ...
                                        <Link
                                            href="/compare-plans"
                                            className="btn btn-primary bg-primary-1"
                                        >
                                            Extends your subscription now!
                                        </Link>
