...
const SquadChat = (props: NextPageProps) => {
    ...
    const [messages, setMessages] = useState<WithId<IChat>[]>([]);
    ...
    return (
        ...
        >
                    ...
                    {messages.map((msg) => (
                        ...
                        >
                            ...
                            session?.user.id ? (
                                ...
                                <div
                                    className={cx(styles["message-box-right"])}
                                >
                                    <span
                                        className={cx(
                                            styles["message-text-right"]
                                        )}
                                    >
                                        {msg.text}
                                    </span>
            ...
            <div className={cx(styles["input-container"])}>
                ...
                <FaImage
                    fill="#ED154C"
                    style={{ width: "5%", height: "auto", margin: "0 1%" }}
                />
                <input
                    type="text"
