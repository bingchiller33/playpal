...
import {
    ...
    setDefault,
    updateOption,
} from "./ManageLOLModeFilter.server";
import { WithId } from "@/utils/types";
import { useEffect, useState } from "react";
import { toast } from "react-toastify";
import { IDefaultFilter } from "@/models/defaultFiltersModel";

const ManageLOLModeFilter = (props: ManageLanguageFilterProps) => {
    ...
    return (
        <div>
            <h2>Manage Mode Filter Settings: </h2>
...
export default ManageLOLModeFilter;
